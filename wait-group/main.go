...
func main() {
	...
	if fp > tp {
		log.Fatalln("Invalid values for 'from' and 'to' ports")
	}

	var wg sync.WaitGroup
	numGoRoutinesToWaitOn := tp - fp + 1
	// If you know ahead of time how many you'll need,
	// its a good idea to add it early.
	// If you don't, make sure to add before the goroutine
